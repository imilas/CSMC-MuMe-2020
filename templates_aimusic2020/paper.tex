...
\resizebox{\textwidth}{!}{%
    \begin{tabular}{|>{\centering\arraybackslash}p{1cm}|>{\centering\arraybackslash}p{10cm}|>{\centering\arraybackslash}p{2cm}|}
    \hline
    Model & Architecture Layout                                                                             & Features                 \\ \hline
    CNN   & CNN(2 channel convolution) -\textgreater LSTM(800 hidden states) -\textgreater Linear (shape 400x5)                                 & Spectrogram          \\ \hline
    FC    & Fully connected Linear layers with shape: 400x10x5x10x5                                & Spectrogram          \\ \hline
    E+F   & Fully connected network of size ix10x2x5 & Env. + Freq. \\ \hline
    MEM   & Encoder -\textgreater Trees Classifier                                              & Spectrogram          \\ \hline
    \end{tabular}
}
\end{table}
...
\ultirow{2}{*}{TPE} & No Drops          & 257  & 0.37 & 0.35 & 0.36  & 0.36  &       \\ \cline{2-8} 
