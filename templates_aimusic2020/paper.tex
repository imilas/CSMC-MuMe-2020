...
\textbf{Conclusion:} We successfully built a generative systems for creation of percussive sounds via automatic programming of virtual synthesizers. We verified its results with human listeners.
...
\textbf{Future Work:} Effective implementation of few-shot learning is a priority. Program generation can be improved by reinforcement learning and other heuristics.
