...
The virtual ear receives sounds and discards those which do not resemble drums. Accepted sounds are assigned a drum category. Our goal is not realism; We want the virtual ear to accept novel and unusual drum sounds. The virtual ear makes two critical decisions: 
\emph{
\begin{quote}
...
% \textbf{Visual Representation of FFT Features}\par\medskip
    \makebox[\textwidth]{\includegraphics[width=0.85\paperwidth]{templates_aimusic2020/images/ff3.pdf}}
...
\end{enumerate}
% Our transformations are GPU based, allowing their application in tandem with the training of the classifier or tuning of STFT transformation during hyper-paramter optimization (see Appendix~\ref{appendix:hyperparam}).
...
\section{Conclusion, Validity, and Future Work} [in progress, need sleep] \\
