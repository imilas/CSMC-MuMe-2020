...
To maximize the transference of knowledge from training the classifiers to evaluation of programs, we need to extract concise feature sets that capture fundamental characteristics of the data points.\\
...
\multirow{2}{*}{TPE} & No Drops          & 257  & 0.37 & 0.35 & 0.36  & 0.36  &       \\ \cline{2-8} 
                     & Bads and Others   & 154  & 0.47 & 0.59 & 0.54  & 0.50  &       \\ \hline
...
\textbf{Conclusion:} We successfully built generative systems for creation of percussive sounds via automatic programming of virtual synthesizers. verified its results with human listeners.
...
\textbf{Future Work:} Effective implementation of few-shot learning is a priority. Program generation can be improved by reinforcement learning and other heuristics.Effective implementation of few-shot learning is a priority. Program generation can be improved by reinforcement learning and other heuristics.
...
\item E/F-DVD: A fully connected model trained on a concatenation of envelope and frequency features. Reaching 80\% accuracy for 5-way drum categorization in Phase 2. Size of 50x10x2x6.
\item CNN-DVD: A CNN model trained on Spectrum features. Reaching 82\% accuracy in a 5-way drum categorization in Phase 2. A combination of a CNN model with output channel size of 4, kernel of size of 5, another CNN model with output channel size of 8 and kernel of size 3. Followed by a fully connected network of shape 100x20x6.
\item FC-DVD: Fully connected 3 layer neural net with 78\% accuracy for 5-way drum categorization in Phase 2. Size of 400x200x50.
\end{enumerate}
