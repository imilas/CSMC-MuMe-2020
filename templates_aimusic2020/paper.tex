...
\titlerunning{Percussive Synth. Generation}
...
The virtual ear receives sounds and discards those which do not resemble drums. It then classifies sounds by drum category. Our goal is not realism; We want the virtual ear to accept novel and unusual drum sounds. The virtual ear makes two critical decisions: 
\emph{
\begin{quote}
