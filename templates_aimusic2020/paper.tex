...
\begin{center}
    ...
    \makebox[\textwidth]{\includegraphics[width=0.7\paperwidth]{images/mme_comparisons_mme.pdf}}
...
\begin{center}
    ...
    \makebox[\textwidth]{\includegraphics[width=0.7\paperwidth]{images/mme_comparisons_dvn.pdf}}
...
\begin{center}
    ...
    \makebox[\textwidth]{
    \subfloat[Precision, recall, F1-Score, and number of supporting examples]{ \includegraphics[width=7cm,height=7cm]{images/f1_mme.pdf}
...
\begin{center}
    \makebox[\textwidth]{
    \subfloat[Confusion matrices]{ \includegraphics[width=7cm,height=7cm]{images/conf_mme.pdf}
...
Using the optuna optimization tools \cite{akiba2019optuna}, we conducted 500 search trials. The trial's success is measured in their final loss value, calculated by applying the model to test data-set. Each trial consisted of 20 epochs of training.
...
\begin{center}
    ...
    \makebox[\textwidth]{\includegraphics[width=0.85\paperwidth]{images/slice_plot.pdf}}
